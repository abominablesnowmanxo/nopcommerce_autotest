...
class RegistrationPage(BasePage):
    ...
    def _enter_company_name(self, company_name):
        self.driver.find_element(
    ...
    def _enter_day_of_birth(self, day):
    ...
    def user_can_registrer_providing_required_fields_only(self):
        user = User()
        self._enter_first_name(user.first_name)
        self._enter_last_name(user.last_name)
        self._enter_email(user.email)
        self._enter_password(user.password)
        self._enter_confirm_password(user.password)
    ...
    def user_can_register_providing_all_the_fields(self):
        ...
        self._enter_first_name(user.first_name)
        self._enter_last_name(user.last_name)
        self._enter_day_of_birth(user.day_of_birth)
        self._enter_month_of_birth(user.month_of_birth)
        self._enter_year_of_birth(user.year_of_birth)
        self._enter_email(user.email)
        self._enter_company_name(user.company)
        self._enter_password(user.password)
        self._enter_confirm_password(user.password)
        self._click_submit_button()
    ...
    def user_cannot_register_if_password_and_confirm_password_fields_do_not_match(self):
        ...
        self._enter_email(user.email)
        self._enter_password(user.password)
        self._enter_confirm_password(user.password_mismatch)
        self._click_submit_button()
    ...
    def user_cannot_register_if_password_has_less_that_six_chars(self, short_password):
        ...
        self._enter_last_name(user.last_name)
        self._enter_email(user.email)
        self._enter_password(short_password)
        self._enter_confirm_password(short_password)
        self._click_submit_button()
    ...
    def register_new_user(self, firstname, lastname, email, password):
        self._enter_first_name(firstname)
        self._enter_last_name(lastname)
        self._enter_email(email)
        self._enter_password(password)
        self._enter_confirm_password(password)
        self._click_submit_button()

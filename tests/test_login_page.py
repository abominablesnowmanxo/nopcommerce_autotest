...
def test_user_can_login_with_valid_email_and_valid_password_001(driver):
...
def test_user_cant_login_with_invalid_email_and_invalid_password_002(driver):
    page = LoginPage(driver, LOGIN_PAGE_URL)
    page.open_page()
...
def test_user_cant_login_with_valid_email_and_invalid_password_003(driver):
    page = LoginPage(driver, LOGIN_PAGE_URL)
    page.open_page()
...
def test_user_cant_login_with_invalid_email_and_valid_password_004(driver):
    page = LoginPage(driver, LOGIN_PAGE_URL)
    page.open_page()
...
def test_user_cant_login_with_empty_email_and_password_fields_005(driver):
    page = LoginPage(driver, LOGIN_PAGE_URL)
    page.open_page()
...
def test_forgot_password_link_is_present_and_lead_to_password_recovery_page_006(driver):
    page = LoginPage(driver, LOGIN_PAGE_URL)
    page.open_page()
...
def test_user_can_go_to_register_page_clicking_regiter_button_007(driver):
    page = LoginPage(driver, LOGIN_PAGE_URL)
    page.open_page()
